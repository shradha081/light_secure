 ...
 <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <p><img src="images/login33.jpg" width="199" height="153" /></p>
          <form action="Cloud_check.jsp" method="post" id="leavereply">
            <label for="username"><br />
              Username (required)&nbsp;&nbsp; </label>
            <input name="username" type="text" class="inputs" id="username" placeholder="username" value="" />
            <label for="username"><br />
            <br />
