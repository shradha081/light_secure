							...
							<div class="content_resize">
								<div class="mainbar">
									<div class="article">
										...
										<h2>Data User File Access Privilege</h2>
										<BR>
										<table border="2" style="text-align: center;">
											...
											<tbody>
												...
												<tr>
													<td data-order="<%=rs.getInt(3)%>"><%=rs.getInt(3)%></td>
													...
													<td><a
														href="keygeneratedcloud.jsp?id=<%=rs.getInt(1)%>">send
													</a></td>
												</tr>
												<%
													}
									...
									<div class="gadget">
										...
										<ul class="sb_menu">
											...
											<li><a href="Cloudrequest.jsp">file and access
													privelege </a></li>
											<li><a href="Cloudrequestaccess.jsp">view file
													access reqeust </a></li>
