					...
					<div class="content">
						<div class="content_resize">
							<div class="mainbar">
								<div class="article">
									<h2>
										<span>Trust Login </span>
									</h2>
									<p>
										<img src="images/nkj.jpg" width="499" height="253" />
									</p>
									<form action="TA_check.jsp" method="post" id="leavereply">
										<label for="username"><br /> Username
											(required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
										<!--   <input name="name" type="text" class="box" id="name" value="" />  -->
										<input type="username" class="inputs" type="text" id="name"
											name="username" value="" placeholder="Username" />
											 <label for="email"><br /> <label for="password"><br />
												password (required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label> <!--   <input name="name" type="text" class="box" id="name" value="" />  -->
											<input type="password" class="inputs" type="text"
