...
<button class="dropbtn">Data User 
 ...
 <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <br><h2>Public Key Request</h2><br>
         <div class="clr"></div>
         <!---Start Body --->
			...
			<tbody>
				...
				<%
					try {
						...
						ResultSet rs;
						String sql = "select * from dataowner where name='" + name
								+ "'";
				...
				<tr>
				  ...
				  <td data-order="<%=rs.getString(10)%>"><%=rs.getString(10)%></td>
					<td> <a href="mail.jsp?id=<%=rs.getInt(1)%>&name=<%=rs.getString("name")%>&omail=<%=rs.getString("omail")%>">send </a> </td>
