										...
										<tbody>
											...
											<%
												try {
													...
													ResultSet rs;
													String sql = "select * from datauser where uname='" + uname
															+ "'";
											...
											<tr>
												...
												<td data-order="<%=rs.getString(12)%>"><%=rs.getString(12)%></td>
												<%-- <td> <a href="keygenerateduserta.jsp?uname=<%=rs.getString("uname")%>&email=<%=rs.getString("email")%>&fileaccessattribute=<%=rs.getString("fileaccessattribute")%>">send request</a> </td>

					 --%>
												<td><a
													href="mailuser.jsp?id=<%=rs.getInt(1)%>&uname=<%=rs.getString("uname")%>&email=<%=rs.getString("email")%>&fileaccessattribute=<%=rs.getString("fileaccessattribute")%>&fileaccess=<%=rs.getString("fileaccess")%>&state=<%=rs.getString("state")%>&country=<%=rs.getString("country")%>">Generate
														Key</a></td>
											</tr>
											<%
												}
							...
							<div class="sidebar">
								<div class="gadget">
									...
									<ul class="sb_menu">
										...
										<li><a href="TA_Ownerpublic.jsp"><span>View
													Data Owner Public key Request</span></a></li>
										<li><a href="TA_Userattribute.jsp">View Data User
												Attribute key Request</a>
										<li><a href=viewownerdetails.jsp><span>Data
													Owner Details</span></a></li>
										<li><a href=viewuserdetails.jsp><span>Data
