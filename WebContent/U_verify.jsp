					...
					<div class="content_resize">
						<div class="mainbar">
							<div class="article">
								<h2>Verification</h2>
								<p>
									<img src="images/skey.png" width="400" height="203" />
								</p>
								<form action="U_verifycheck.jsp" method="post" id="leavereply">

									<label for="name"><br /> <br /> Secret Key
										(required)&nbsp;&nbsp; </label>
									<!-- <input type="password" id="password" name="password" class="box" /> -->
									<input type="password" id="password" class="inputs"
										name="secret_key" value="" placeholder="skey" />
									<p>&nbsp;</p>
									<button class="button" type="submit">Login</button>
									<button class="button" type="reset">RESET</button>
									<p>
										New Secretkey? click here to <a href="U_verify.jsp">
											Secretkey</a>
									</p>
								</form>
								<!-- <p class="infopost">&nbsp;</p> -->
