									...
									<div class="gadget">
										...
										<table border="1" style="text-align: center; margin-left: 0px">
											<tr>
												...
												<!--  <th style="text-align: center;width: 100px; font-size: 16px; color: #ffffff">Download</th> -->
											</tr>
											<tr>
												<%
													Connection con = null;
													...
													try {
														...
														rs = st.executeQuery("select * from request1  ");
														while (rs.next())
								...
								<div class="gadget">
									...
									<ul class="sb_menu">
										...
										<li><a href="viewuploadowner.jsp">Uploaded File
												Details</a></li>
										<li><a href="Viewdownload.jsp"><span>Download
													File</span></a></li>
