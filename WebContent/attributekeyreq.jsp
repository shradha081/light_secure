...
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title>attribute key request</title>
						...
						<div class="content_resize">
							<div class="mainbar">
								<div class="article">
									...
									<table border="1" style="text-align: center; margin-left: 0px">
										<tr>
											<th style="text-align: center; width: 30px; font-size: 16px;">ID</th>
											<th
												style="text-align: center; width: 300px; font-size: 16px;">Name</th>
											<th
												style="text-align: center; width: 100px; font-size: 16px;">Email</th>
											<th
												style="text-align: center; width: 100px; font-size: 16px;">status</th>
											<th
												style="text-align: center; width: 100px; font-size: 16px;">Give
												Request</th>

											<!--  <th style="text-align: center;width: 100px; font-size: 16px; ">Response</th> -->
										</tr>
										<tr>
											<%
												...
												try {
													...
													rs = st.executeQuery("select * from datauser where status='waiting'");
													while (rs.next())
										...
										<tr>
											...
											<td><a
												href="keygenerateduser.jsp?id=<%=rs.getInt("id")%>">Give
													Request</a></td>
										</tr>
							...
							<div class="sidebar">
								<div class="gadget">
									...
									<div class="clr"></div>
									<ul class="sb_menu">
										<li><a href="U_Home.jsp">Data Owner Home</a></li>
										<li><a href="attributekeyreq.jsp">Access file
												privlege</a></li>
										<li><a href="attributekeyverify.jsp"><span>Attribute
													key Request</span></a></li>
										<li><a href="viewuploadowner.jsp">Uploaded File
												Details</a></li>
