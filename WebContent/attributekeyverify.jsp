...
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title>attribute key verify</title>
...
%>
<script>
	alert('attributekey verify Succesfully');
</script>
<%
	}
%>
			...
			<div class="logo">
				...
				<div class="content">
					<div class="content_resize">
						<div class="mainbar">
							<div class="article">
								<h2>Attribute key verify</h2>
								<p>
									<img src="images/veri.jpg" width="400" height="203" />
								</p>
								<form action="attributekey_verifycheck.jsp" method="post"
									id="leavereply">

									<label for="name"><br /> <br /> Attribute Key
										(required)&nbsp;&nbsp; </label>
									<!-- <input type="password" id="password" name="password" class="box" /> -->
									<input type="password" id="password" class="inputss"
										name="pkey" value="" placeholder="pkey" />
									<p>&nbsp;</p>
									<p>
									...
									<p>
										New attributekeyverify? click here to <a
											href="attributekeyverify.jsp"> Attributekey</a>
									</p>
								</form>
								<!-- <p class="infopost">&nbsp;</p> -->
						...
						<div class="sidebar">
							<div class="gadget">
								...
								<ul class="sb_menu">
									...
									<li><a href="ulogin.jsp">Data User</a></li>
