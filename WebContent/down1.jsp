					...
					<div class="slider">
						<div id="coin-slider">
							<a href="#"><img src="images/c7.jpg" width="960" height="335"
								alt="" /> </a> <a href="#"> <img src="images/nkj.jpg"
								width="960" height="335" alt="" />
									...
									<div class="gadget">
										...
										<table border="1" style="text-align: center; margin-left: 0px">
											<tr>
												...
												<th
													style="text-align: center; width: 200px; font-size: 16px; color: #ffffff">User</th>
												<th
													style="text-align: center; width: 100px; font-size: 16px; color: #ffffff">Date</th>
												<th
													style="text-align: center; width: 100px; font-size: 16px; color: #ffffff">Download</th>
											</tr>
											<tr>
												<%
													Connection con = null;
												...
												<td><a href="Download?id=<%=rs.getString("id")%>"><font
														style="color: #ffffff; font-size: 16px">Download</a></font></td>
											<tr />
											<%
												}
												} catch (Exception ex) {
