...
%>
<script>
	alert('download key Succesfully');
</script>
<%
	}
%>
			...
			<div class="logo">
				...
				<div class="content">
					<div class="content_resize">
						<div class="mainbar">
							<div class="article">
								<h2>Decrypted the Download</h2>
								<p>
									<img src="images/Down.JPG" width="199" height="153" />
								</p>
								<form action="login1.jsp" method="get"
									enctype="multipart/form-data">

									<label for="name"><br /> <br /> Download Key
										(required)&nbsp;&nbsp; </label>
									<!-- <input type="password" id="password" name="password" class="box" /> -->
									<input type="password" id="password" class="inputs"
										name="downloadkey" placeholder="downloadkey" />
									<p>&nbsp;</p>
									<p>
									...
									<p>
										New downloadkey click here to <a href="downloadkey.jsp">
											Register</a>
									</p>
								</form>
