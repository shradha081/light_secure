...
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title>Public key Request</title>
								...
								<div class="article">
									...
									<table border="1" style="text-align: center; margin-left: 0px">
										...
										<tr>
											<%
												...
												try {
													...
													rs = st.executeQuery("select * from dataowner where status='waiting'");
													while (rs.next())
										...
										<tr>
											...
											<td><%=rs.getString("omail")%></td>
											<%--   <td><%=rs.getString("country")%></td>  --%>
											<td><%=rs.getString("status")%></td>
											<td><a
												href="keygenerated.jsp?id=<%=rs.getString("id")%>">Generate
													Key</a></td>
										</tr>
