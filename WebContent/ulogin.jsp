					...
					<div class="content_resize">
						<div class="mainbar">
							<div class="article">
								...
								<form action="ulogincheck.jsp" method="post" id="leavereply">
									<label for="name"><br /> Name
										(required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
									<!--   <input name="name" type="text" class="box" id="name" value="" />  -->
									<input type="text" class="inputs" id="name" name="uname"
										placeholder="Your Name" /> <label for="name"><br />
									...
									<p>
										New Data User? click here to <a href="ureg.jsp"> Register</a>
									</p>
								</form>
								<!-- <p class="infopost">&nbsp;</p> -->
