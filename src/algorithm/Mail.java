...
public class Mail {
    ...
    public static boolean secretMail(String secret_key, String pkey, String name, String omail) {
        ...
        try {
          ...
          message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(omail));
	...
	private static RecipientType Message(RecipientType to,
